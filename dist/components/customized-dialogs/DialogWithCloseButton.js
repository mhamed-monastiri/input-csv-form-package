...
function DialogWithCloseButton(_a) {
    var { open = false, variants, onClose, children, sx } = _a, other = __rest(_a, ["open", "variants", "onClose", "children", "sx"]);
    return (React.createElement(material_1.Dialog, Object.assign({ open: open, onClose: onClose }, other),
...
exports.default = DialogWithCloseButton;
